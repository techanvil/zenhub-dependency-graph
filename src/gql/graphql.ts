...
/** Autogenerated input type of ChangeIssueTypeOfIssues */
export type ChangeIssueTypeOfIssuesInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  issueIds: Array<Scalars['ID']['input']>;
  issueTypeId?: InputMaybe<Scalars['ID']['input']>;
  removeIssueType?: InputMaybe<Scalars['Boolean']['input']>;
};

/** Autogenerated return type of ChangeIssueTypeOfIssues. */
export type ChangeIssueTypeOfIssuesPayload = {
  __typename?: 'ChangeIssueTypeOfIssuesPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  failedIssues?: Maybe<Array<Issue>>;
...
/** Autogenerated input type of CreateBlockage */
export type CreateBlockageInput = {
  blocked: IssueDependencyInput;
  blocking: IssueDependencyInput;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
};

/** Autogenerated return type of CreateBlockage. */
export type CreateBlockagePayload = {
  __typename?: 'CreateBlockagePayload';
  blockage: Blockage;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};
...
export type CreatePipelineAutomationInput = {
   ...
   * sprint2_eid] }. For relative sprints: { relativeSprints: [0, 1, 2] }, where
   * numbers are index of sprints from the current sprint. To remove all sprints
   * pass empty array { relativeSprints: [] }. for pipelines: { pipelines:
   * [pipeline1_eid, pipeline2_eid] }
   */
...
export enum IssueDependencyField {
  Issue = 'ISSUE',
  ZenhubEpic = 'ZENHUB_EPIC'
}

/** A reference to polymorphic issue dependency input via id and its type */
export type IssueDependencyInput = {
  id: Scalars['ID']['input'];
  type: IssueDependencyField;
};
...
export enum IssueOrderField {
  ...
  Stale = 'stale',
  /** Order by time spent in pipeline */
  TimeInPipeline = 'time_in_pipeline',
...
export type Mutation = {
  ...
  /** Change IssueType of multiple Issues */
  changeIssueTypeOfIssues?: Maybe<ChangeIssueTypeOfIssuesPayload>;
  ...
  /** Creates a blocking-blocked dependency */
  createBlockage?: Maybe<CreateBlockagePayload>;
  /** Creates a comment */
...
export type MutationChangeIssueTypeOfIssuesArgs = {
  input: ChangeIssueTypeOfIssuesInput;
};
...
export type MutationCreateBlockageArgs = {
  input: CreateBlockageInput;
};
...
export type PipelineConfiguration = Timestamps & {
  ...
  showAgeInPipeline?: Maybe<Scalars['Boolean']['output']>;
...
export type UpdatePipelineConfigurationInput = {
  ...
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  pipelineId: Scalars['ID']['input'];
  showAgeInPipeline?: InputMaybe<Scalars['Boolean']['input']>;
...
export type UpdateWorkspaceInput = {
  ...
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  defaultRepositoryGhId?: InputMaybe<Scalars['Int']['input']>;
  defaultSavedViewId?: InputMaybe<Scalars['ID']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
  name: Scalars['String']['input'];
  private?: InputMaybe<Scalars['Boolean']['input']>;
  workspaceId: Scalars['ID']['input'];
...
export type Workspace = Timestamps & ViewerPermission & {
  ...
  defaultSavedView?: Maybe<SavedView>;
  description?: Maybe<Scalars['String']['output']>;
...
export type WorkspaceIssuesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  filters?: InputMaybe<WorkspaceIssuesFiltersInput>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type WorkspaceIssuesFiltersInput = {
  /**
   * When true, workspace label filters are ignored, allowing queries for issues in
   * the same repositories without workspace labels
   */
  ignoreWorkspaceLabels?: InputMaybe<Scalars['Boolean']['input']>;
  issueIssueTypeDisposition?: InputMaybe<IssueIssueTypeDispositionInput>;
  issueIssueTypes?: InputMaybe<StringInput>;
  labels?: InputMaybe<StringInput>;
  parentIssues?: InputMaybe<ParentIssuesInput>;
...
export type WorkspaceOrderInput = {
  direction?: InputMaybe<OrderDirection>;
  field?: InputMaybe<WorkspaceOrderField>;
};
...
export enum ZenhubLabelOrderField {
  /** Order by label name */
  Name = 'name'
}

/** Sort zenhub labels */
export type ZenhubLabelOrderInput = {
  direction: OrderDirection;
  field: ZenhubLabelOrderField;
};
...
export type ZenhubOrganizationZenhubLabelsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<ZenhubLabelOrderInput>;
};
...
export type GetWorkSpaceQuery = { __typename?: 'Query', viewer: { __typename?: 'ZenhubUser', id: string, searchWorkspaces: { __typename?: 'WorkspaceConnection', nodes: Array<{ __typename?: 'Workspace', id: string, name?: string | null, zenhubOrganization: { __typename?: 'ZenhubOrganization', id: string, name?: string | null }, activeSprint?: { __typename?: 'Sprint', id: string, name?: string | null } | null, sprints: { __typename?: 'SprintConnection', nodes: Array<{ __typename?: 'Sprint', id: string, name?: string | null }> } }> } } };
...
export type GetRepoAndPipelinesQuery = { __typename?: 'Query', workspace?: { __typename?: 'Workspace', id: string, defaultRepository?: { __typename?: 'Repository', id: string, ghId: number } | null, pipelinesConnection: { __typename?: 'PipelineConnection', nodes: Array<{ __typename?: 'Pipeline', id: string }> } } | null };

export type GetEpicChildIssuesQueryVariables = Exact<{
  workspaceId: Scalars['ID']['input'];
  repositoryGhId: Scalars['Int']['input'];
...
export type GetEpicChildIssuesQuery = { __typename?: 'Query', issueByInfo: { __typename?: 'Issue', githubChildIssues: { __typename?: 'IssueConnection', nodes: Array<{ __typename?: 'Issue', id: string, number: number, title: string, body?: string | null, htmlUrl: string, state: IssueState, assignees: { __typename?: 'UserConnection', nodes: Array<{ __typename?: 'User', id: string, login: string }> }, blockingIssues: { __typename?: 'IssueConnection', nodes: Array<{ __typename?: 'Issue', id: string, number: number }> }, blockedIssues: { __typename?: 'IssueConnection', nodes: Array<{ __typename?: 'Issue', id: string, number: number }> }, pipelineIssue?: { __typename?: 'PipelineIssue', id: string, pipeline: { __typename?: 'Pipeline', id: string, name: string } } | null, estimate?: { __typename?: 'Estimate', value: number } | null, sprints: { __typename?: 'SprintConnection', nodes: Array<{ __typename?: 'Sprint', id: string, name?: string | null }> } }> } } };
...
export type GetIssueByNumberQuery = { __typename?: 'Query', issueByInfo: { __typename?: 'Issue', id: string, number: number, title: string, body?: string | null, htmlUrl: string, state: IssueState, assignees: { __typename?: 'UserConnection', nodes: Array<{ __typename?: 'User', id: string, login: string }> }, pipelineIssue?: { __typename?: 'PipelineIssue', id: string, pipeline: { __typename?: 'Pipeline', id: string, name: string } } | null, blockingIssues: { __typename?: 'IssueConnection', nodes: Array<{ __typename?: 'Issue', id: string, number: number }> }, blockedIssues: { __typename?: 'IssueConnection', nodes: Array<{ __typename?: 'Issue', id: string, number: number }> }, sprints: { __typename?: 'SprintConnection', nodes: Array<{ __typename?: 'Sprint', id: string, name?: string | null }> }, estimate?: { __typename?: 'Estimate', value: number } | null } };

export type GetSimpleIssueByNumberQueryVariables = Exact<{
  repositoryGhId: Scalars['Int']['input'];
  issueNumber: Scalars['Int']['input'];
}>;


export type GetSimpleIssueByNumberQuery = { __typename?: 'Query', issueByInfo: { __typename?: 'Issue', id: string, number: number, title: string } };

export type GetAllOrganizationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllOrganizationsQuery = { __typename?: 'Query', viewer: { __typename?: 'ZenhubUser', id: string, zenhubOrganizations: { __typename?: 'ZenhubOrganizationConnection', nodes: Array<{ __typename?: 'ZenhubOrganization', id: string, name?: string | null, workspaces: { __typename?: 'WorkspaceConnection', nodes: Array<{ __typename?: 'Workspace', id: string, name?: string | null }> } }> } } };
...
export type GetAllEpicsQuery = { __typename?: 'Query', workspace?: { __typename?: 'Workspace', id: string, epics?: { __typename?: 'EpicConnection', nodes: Array<{ __typename?: 'Epic', id: string, issue: { __typename?: 'Issue', id: string, number: number, title: string, closedAt?: any | null } }> } | null } | null };

export type CreateBlockageMutationVariables = Exact<{
  blockingId: Scalars['ID']['input'];
  blockedId: Scalars['ID']['input'];
}>;


export type CreateBlockageMutation = { __typename?: 'Mutation', createBlockage?: { __typename?: 'CreateBlockagePayload', blockage: { __typename?: 'Blockage', id: string } } | null };

export type DeleteIssueDependencyMutationVariables = Exact<{
  repositoryGhId: Scalars['Int']['input'];
  blockingIssueNumber: Scalars['Int']['input'];
  blockedIssueNumber: Scalars['Int']['input'];
}>;


export type DeleteIssueDependencyMutation = { __typename?: 'Mutation', deleteIssueDependency?: { __typename?: 'DeleteIssueDependencyPayload', issueDependency: { __typename?: 'IssueDependency', id: string } } | null };
...
export const GetSimpleIssueByNumberDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSimpleIssueByNumber"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"repositoryGhId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"issueNumber"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"issueByInfo"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"issueNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"issueNumber"}}},{"kind":"Argument","name":{"kind":"Name","value":"repositoryGhId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"repositoryGhId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"number"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]} as unknown as DocumentNode<GetSimpleIssueByNumberQuery, GetSimpleIssueByNumberQueryVariables>;
...
export const CreateBlockageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateBlockage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"blockingId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"blockedId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createBlockage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"blocking"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"blockingId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"ISSUE"}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"blocked"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"blockedId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"EnumValue","value":"ISSUE"}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"blockage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<CreateBlockageMutation, CreateBlockageMutationVariables>;
export const DeleteIssueDependencyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteIssueDependency"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"repositoryGhId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"blockingIssueNumber"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"blockedIssueNumber"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteIssueDependency"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"blockingIssue"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"repositoryGhId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"repositoryGhId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"issueNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"blockingIssueNumber"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"blockedIssue"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"repositoryGhId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"repositoryGhId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"issueNumber"},"value":{"kind":"Variable","name":{"kind":"Name","value":"blockedIssueNumber"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"issueDependency"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<DeleteIssueDependencyMutation, DeleteIssueDependencyMutationVariables>;